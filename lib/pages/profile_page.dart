            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  ...
                  if (widget.userModel.name== Null) {print ('eroor');}
                  else {
                  Navigator.push( context, MaterialPageRoute(builder: (context) => HomePage(username: widget.userModel.name!,)), );
                  }
                },
              ),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  Text('yasmine', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),),
                  SizedBox(height: 20,),
                  SizedBox(height: 10,),
                  Container(
                    padding: EdgeInsets.all(10),
                                    ...
                                    ...ListTile.divideTiles(
                                      ...
                                      tiles: [
                                        ListTile(
                                          ...
                                          title: Text("Location"),
                                          subtitle: Text("TINISIA"),
                                        ),
                                        ListTile(
                                          leading: Icon(Icons.email),
                                          title: Text("Email"),
                                          subtitle: Text(user.email ?? 'unavaible'),
                                        ),
                                        ListTile(
                                          leading: Icon(Icons.phone),
                                          title: Text("Phone"),
                                          subtitle: Text(user.mobile ?? 'unavaible'),
                                        ),
